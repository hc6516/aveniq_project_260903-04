...
export function validateSignup(body) {
  ...
  return { data: { phone, email, privacy_agreed_at: now, privacy_consent_version: CONSENT_VERSION, marketing_consent: channels.length > 0, marketing_consent_at: channels.length ? now : null, marketing_consent_channels: channels, marketing_consent_version: channels.length ? CONSENT_VERSION : null, source: 'aveniq-web-v2' } };
}
